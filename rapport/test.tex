...
\usepackage{listings}
\title{Rapport de développement d'une super calculatrice \\[3mm] \normalsize{\it Laboratoire de concepts informatiques}}
...
\begin{document}
blaefjklqslkjqskfdhqsdlkjfh kjsdfhlkjsdflk skjhdflskqjhlk

\lstinputlisting[language=html]{\file{templates/test.txt}}
